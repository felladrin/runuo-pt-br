...
namespace Server.Engines.MLQuests.Definitions
{
	...
	public class TheRightToolForTheJob : MLQuest
	{
		public TheRightToolForTheJob()
		{
			...
			RefusalMessage = 1077745; // I抦 disappointed that you aren抰 interested in learning more about Tinkering. It抯 really such a useful skill!<br><br>*Amelia smiles*<br><br>At least you know where to find me if you change your mind, since I rarely spend time outside of this shop.
			...
			Rewards.Add( new ItemReward( 1077749, typeof( AmeliasToolbox ) ) ); // Amelia抯 Toolbox
		}
	...
	public class TheDeluciansLostMine : MLQuest
	{
		public TheDeluciansLostMine()
		{
			Activated = true;
			OneTimeOnly = true;
			Title = 1077750; // The Delucian抯 Lost Mine
			...
			RefusalMessage = 1077754; // Couldn抰 find my iron mine, could ya? Well, neither can I!<br><br>*Jacob laughs*<br><br>Oh, ya don抰 wanna find it? Well, allrighty then, ya might as well head on back down to town then and stop cluttering up my camp. Come back and talk to me if you抮e interested in learnin? 慴out minin?.
			InProgressMessage = 1077755; // Where ya been off a gallivantin? all day, pilgrim? You ain抰 seen no hard work yet! Get yer arse back out there to my mine and dig up some more iron. Don抰 forget to take a pickaxe or shovel, and if you抮e so inclined, a packhorse too.
			CompletionMessage = 1077757; // Dang gun it! If that don't beat all! Ya went and did it, didn抰 ya? What we got ourselves here is a mighty fine brand spankin? new Apprentice Miner!<br><br>I can see ya put some meat on them bones too while you were at it!<br><br>Here抯 that little somethin? I told ya I had for ya. It抯 a pickaxe with some high falutin? magic inside that抣l help you find the good stuff when you抮e off minin?. It wears out fast, though, so you can only use it a few times a day.<br><br>Welp, I抳e got some smeltin? to do, so off with ya. Good luck, pilgrim!
	...
	public class ItsHammerTime : MLQuest
	{
		public ItsHammerTime()
		{
			...
			InProgressMessage = 1077737; // You抮e doing well, but you抮e not quite there yet. Remember that the quickest way to learn is to make daggers up until 45 skill, and then switch to maces. Also, don抰 forget that using my forge and anvil will help you learn faster.
	...
	public class Churchill : BaseCreature
	{
		...
		{
			Name = "Churchill";
            Title = "o instrutor de luta com maças";
			BodyValue = 0x190;
			Hue = 0x83EA;
			HairItemID = 0x203C;
			HairHue = 0x455;
	...
	public class Alefian : BaseCreature
	{
		...
		{
			Name = "Alefian";
            Title = "o instrutor de resistência à magias";
			BodyValue = 0x190;
			Hue = 0x83EA;
			HairItemID = 0x203D;
			HairHue = 0x457;
	...
	public class Gustar : BaseCreature
	{
		...
		{
			Name = "Gustar";
			Title = "o instrutor de meditação";
			BodyValue = 0x190;
			Hue = 0x83F5;
			HairItemID = 0x203B;
			HairHue = 0x455;
	...
	public class Jillian : BaseCreature
	{
		...
		{
			Name = "Jillian";
            Title = "a instrutora de inscrição";
			BodyValue = 0x191;
			Female = true;
			Hue = 0x83EA;
			HairItemID = 0x203D;
	...
	public class Mithneral : BaseCreature
	{
		...
		{
			Name = "Mithneral";
			Title = "o instrutor de avaliação de inteligência";
			BodyValue = 0x190;
			Hue = 0x83EA;
			HairItemID = 0x203C;
			HairHue = 0x455;
	...
	public class Morganna : Mage
	{
		...
		{
			Name = "Morganna";
			Title = "a instrutora de conversas com espíritos";
			BodyValue = 0x191;
			Female = true;
			Hue = 0x83EA;
			HairItemID = 0x203C;
	...
	public class JacobWaltz : BaseCreature
	{
		...
		{
			Name = "Jacob Waltz";
			Title = "o instrutor de mineração";
			BodyValue = 0x190;
			Hue = 0x83EA;
			HairItemID = 0x2048;
			HairHue = 0x44E;
